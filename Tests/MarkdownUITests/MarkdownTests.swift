    ...
    extension SnapshotTests {
        @MainActor
        @Suite(.enabled(if: SnapshotTestSupport.supportsPhoneSnapshots, "Skipping on iPad")) struct MarkdownTests {
            ...
            @Test func softBreakModeLineBreak() {
                let view = MarkdownView {
                    #"""
                    # This is a heading
