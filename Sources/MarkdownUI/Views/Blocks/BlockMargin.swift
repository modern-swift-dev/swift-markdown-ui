...
public extension View {
    ...
    func markdownMargin(top: RelativeSize) -> some View {
    ...
    func markdownMargin(bottom: RelativeSize) -> some View {
    ...
    func markdownMargin(top: RelativeSize?, bottom: RelativeSize?) -> some View {
    ...
    ///                  together with other blocks.
    func markdownMargin(top: CGFloat) -> some View {
        self.markdownMargin(top: top, bottom: nil)
    }
    ...
    ///                     block together with other blocks.
    func markdownMargin(bottom: CGFloat) -> some View {
        self.markdownMargin(top: nil, bottom: bottom)
    }
    ...
    func markdownMargin(top: CGFloat?, bottom: CGFloat?) -> some View {
