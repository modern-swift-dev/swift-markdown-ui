...
public extension BlockStyle where Configuration == ListMarkerConfiguration {
    ...
    static var discCircleSquare: Self {
...
public extension BlockStyle where Configuration == ListMarkerConfiguration {
    /// A list marker style that uses decimal numbers beginning with 1.
    static func decimal(minWidth: RelativeSize, alignment: Alignment = .center) -> Self {
        BlockStyle { configuration in
    ...
    /// A list marker style that uses uppercase roman numerals beginning with `I`.
    static func upperRoman(minWidth: RelativeSize, alignment: Alignment = .center) -> Self {
        BlockStyle { configuration in
    ...
    /// A list marker style that uses lowercase roman numerals beginning with `i`.
    static func lowerRoman(minWidth: RelativeSize, alignment: Alignment = .center) -> Self {
        BlockStyle { configuration in
    ...
    /// A list marker style that uses a dash.
    static func dash(minWidth: RelativeSize, alignment: Alignment = .center) -> Self {
        BlockStyle { _ in
            Text("-")
                .relativeFrame(minWidth: minWidth, alignment: alignment)
        }
    ...
    /// A list marker style that uses a filled circle.
    static func disc(minWidth: RelativeSize, alignment: Alignment = .center) -> Self {
        BlockStyle { _ in
            ListBullet.disc
                .relativeFrame(minWidth: minWidth, alignment: alignment)
        }
    ...
    /// A list marker style that uses a hollow circle.
    static func circle(minWidth: RelativeSize, alignment: Alignment = .center) -> Self {
        BlockStyle { _ in
            ListBullet.circle
                .relativeFrame(minWidth: minWidth, alignment: alignment)
        }
    ...
    /// A list marker style that uses a filled square.
    static func square(minWidth: RelativeSize, alignment: Alignment = .center) -> Self {
        BlockStyle { _ in
            ListBullet.square
                .relativeFrame(minWidth: minWidth, alignment: alignment)
        }
