...
public extension Theme {
    ...
    func heading1(
        @ViewBuilder body: @escaping @MainActor @Sendable (_ configuration: BlockConfiguration) -> some View
    ) -> Theme {
        var theme = self
    ...
    func heading2(
        @ViewBuilder body: @escaping @MainActor @Sendable (_ label: BlockConfiguration) -> some View
    ) -> Theme {
        var theme = self
    ...
    func thematicBreak(
        @ViewBuilder body: @escaping @MainActor @Sendable () -> some View
    ) -> Theme {
        var theme = self
