...
public extension RelativeSize {
    /// A size with a value of zero.
    static let zero = RelativeSize(value: 0, unit: .rem)

    /// Creates a size value relative to the current font size.
    static func em(_ value: CGFloat) -> RelativeSize {
        .init(value: value, unit: .em)
    }

    /// Creates a size value relative to the root font size.
    static func rem(_ value: CGFloat) -> RelativeSize {
        .init(value: value, unit: .rem)
    }

    internal func points(relativeTo fontProperties: FontProperties? = nil) -> CGFloat {
...
public extension View {
    ...
    func relativePadding(_ edges: Edge.Set = .all, length: RelativeSize) -> some View {
        TextStyleAttributesReader { attributes in
    ...
    func relativeLineSpacing(_ lineSpacing: RelativeSize) -> some View {
        TextStyleAttributesReader { attributes in
